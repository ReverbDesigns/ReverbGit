...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/preset2.css"/>
    ...
    <script src="js/simple_validate.js"></script>
	...
	<link href='css/default-styles.css' type="text/css" rel="stylesheet">
    ...
    <form ACTION="https://www.paypal.com/cgi-bin/webscr" METHOD="POST" target="_parent" id='cost_calc_paypal_form'>
        ...
        <div class="cost_calc_summary clearfix">
            <label class="cost_calc_terms_checkbox">
                <input class="SV_validate_checkbox" type="checkbox" style="border: 2px inset #4deecc;cursor: progress;">
          ...
          <div class="lineFive"></div>
            <!--Submit Payment-->
            <input type="submit" NAME="submit" class="submit_form cost_calc_button" style="float:right;font-family:'Blaze';font-weight: bold;" value="PURCHASE">
        </div>
    </form>
    <!--End Form-->
</div>
