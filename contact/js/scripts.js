...
---------------------------------------------------*/	
	...
	if( jQuery('#map_canvas').length > 0 ){					
		var latlng = new google.maps.LatLng(37.488681,-122.242654);
		var settings = {
			zoom: 11,
			center: new google.maps.LatLng(37.488681,-122.242654),
		...
		var contentString = '<div id="content-map-marker" style="text-align:left; padding-top:10px; padding-left:10px">'+
			'<div id="siteNotice">'+
			'</div>'+
			'<h4 id="firstHeading" class="firstHeading" style="color:#000; margin-bottom:0px;"><strong>Hello! In the area?</strong></h4>'+
			'<div id="bodyContent">'+
			'<p style="font-family:Verdana; color:#999; font-size:12px; margin-bottom:10px"> Come stop by for coffee or just to discuss ideas!</p>'+
			'</div>'+
			'</div>';
		...
		var companyPos = new google.maps.LatLng(37.488681,-122.242654);	
