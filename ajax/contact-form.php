...
<html>
 <head>
        <meta http-equiv="refresh" content="3;url=http://www.reverbdesigns.com/" />
    </head>
<body>
<h1 class="align-center"> Thank You! We'll be back to you shortly!Redirecting you now.</h1>
</body>
<?php
...
if( isset( $_REQUEST['contact-form'] ) ) {
	...
	@mail( $sendto, '=?utf-8?B?'. '?=', $email_message, $headers );
